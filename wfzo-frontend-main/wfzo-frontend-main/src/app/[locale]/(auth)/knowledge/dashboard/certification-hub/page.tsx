...
import transformCertificationHub from '@/lib/utils/transformCertificationHub';
...
export default async function CertificationHubPage() {
  ...
  const sections = transformCertificationHub(json) || {};
      ...
      <div className="px-5 md:px-30 py-10">
        ...
        {sections.banner?.description && (
          <ContentSection
            ...
            variant="gold"
            innerClass='px-0!'
            cta={{ title: 'Go to Certification Hub', url: 'https://certificationshub.com/', targetBlank: true, variant: 'gold' }}
          />
        )}
