...
import transformFreeZoneOfTheFutureIndex from '@/lib/utils/transformFreeZoneOfTheFutureIndex';
...
export default async function FreeZoneOfTheFuturePage() {
  ...
  const sections = transformFreeZoneOfTheFutureIndex(json) || {};
      ...
      <div className="px-5 md:px-30 py-10">
        ...
        {sections.banner?.description && (
          <ContentSection
            ...
            variant="gold"
            innerClass='px-0!'
            cta={{ title: 'Go to Free Zone of the Future', url: 'https://izdihar.worldfzo.org', targetBlank: true, variant: 'gold' }}
          />
        )}
