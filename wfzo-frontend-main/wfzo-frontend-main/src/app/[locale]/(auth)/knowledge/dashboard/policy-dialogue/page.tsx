      ...
      />
        ...
        {sections.banner?.description && (
          <ContentSection
            ...
            variant="gold"
            innerClass='px-0!'
            cta={{ title: 'Go to Policy Dialogue', url: 'https://worldfreezone-dev.isorobot.io/', targetBlank: true, variant: 'gold' }}
          />
        )}
