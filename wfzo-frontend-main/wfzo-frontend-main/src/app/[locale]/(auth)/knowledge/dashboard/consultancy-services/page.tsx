        ...
        <div className="py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="w-full">
              <FeaturedMemberFormWrapper enquiryType="consultancy_needs" />
            </div>
          </div>
        </div>
      </div>
