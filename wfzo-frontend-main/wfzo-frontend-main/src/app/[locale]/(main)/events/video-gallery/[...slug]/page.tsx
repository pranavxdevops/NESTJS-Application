...
export default async function VideoGalleryIndividualDetailPage({ params }: PageProps) {
  ...
  return (
    <div>
      ...
      {(sections?.videoResources?.length > 0) && (
