...
import {transformFeaturedMember } from './transformHomepage';

export default function transformMemberDirectory(strapiJson) {
  ...
  const featured = sections.find(s => s.__component === 'home.featured-member'); 
  ...
  return {
    ...
    featuredMember: featured ? transformFeaturedMember(featured) : null
  };
}
