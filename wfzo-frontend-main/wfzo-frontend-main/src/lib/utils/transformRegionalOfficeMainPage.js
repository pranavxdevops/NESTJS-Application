...
export default function transformRegionalOfficeMainPage(strapiJson, allOffices) {
  ...
  const mapOffice = (office, type) => ({
    ...
    slug: office.slug,
    type,
    fullPath: `/about-us/contact-us/${type === 'regional' ? 'regional-offices' : 'national-contact-points'}/${office.slug}`,
  ...
  return {
    ...
    regionalOfficeCards: [
      {
        ...
        description: regionalOffices.officePrimaryDetails,
        offices: roCards ?? [],
      },
    ],
    ...
    nationalContactPointCards: [
      {
        title: ' Other National Contact Points',
        description: nationalOffices.officePrimaryDetails,
        offices: ncpCards ?? [],
      },
    ],
